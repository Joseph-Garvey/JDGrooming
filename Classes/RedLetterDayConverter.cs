...
namespace JDGrooming
{
    public class RedLetterDayConverter : IValueConverter
    {
        ...
        static RedLetterDayConverter()
        {
            ...
            dict.Add(new DateTime(2009, 4, 1), "April Fools"); dict.Add(new DateTime(2009, 4, 22), "Earth Day");
            dict.Add(new DateTime(2009, 5, 1), "May Day"); dict.Add(new DateTime(2009, 5, 10), "Mother's Day");
